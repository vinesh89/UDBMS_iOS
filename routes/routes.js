...
export default class Routes extends React.Component {
  ...
  render() {
    return (
      <Router>
        <Scene key="root">
          <Scene key="login" title="Generate QR Code" titleStyle={styles.navigationBarTitleStyle} navigationBarStyle={styles.navigationBarStyle} hideNavBar={true} component={Login} />
